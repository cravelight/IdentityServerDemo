...
{
    public class ImplicitFlowAccountController : Controller
    {
        ...
        public ActionResult SignIn()
        {
            ...
            var implicitFlowCallbackUri = "https://localhost:44310/ImplicitFlowAccount/SignInCallback";

            var state = Guid.NewGuid().ToString("N");
            var nonce = Guid.NewGuid().ToString("N");

            var url = implicitFlowAuthorizationUri +
                "?client_id=sampleimplicitclient" +
        ...
        public ActionResult SignOut()
        {
            ...
            var identityServerEndpoint = "/identity";
            var identityServerUri = applicationBaseUri + identityServerEndpoint;
            var logoutUri = identityServerUri + @"/connect/endsession";
